...
int ledsInRibs[] = {
4, 9, 13, 18, 22, 27, 32, 36, 41, 45, 50, 55, 59, 64, 68, 73, 75, 75, 75, 75, 75, 75, 75, 75, 75, 75, 73, 68, 64, 59, 54, 50, 45, 41, 36, 32, 27, 22, 18, 12, 9, 2};

#define NUM_LEDS_PER_STRIP 348

int universeLength[] = {125, 122, 164, 132, 148, 150, 150, 150, 150, 148, 132, 59, 149, 158, 41};

int ribsInUniverse[] = {7, 3, 3, 2, 2, 2, 2, 2, 2, 2, 2, 1, 3, 5, 4};

int universeOffsets[] = { 0, 348, 470, 696, 828, 1044, 1194, 1392, 1542, 1740, 1888, 2020, 2088, 2237, 2395};


byte ip[] = {192, 168, 2, 5  };

int START_SUBNET = 8;
int START_UNIVERSE = 6;
