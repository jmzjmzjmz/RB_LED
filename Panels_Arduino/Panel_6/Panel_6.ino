...
#define NUM_LEDS_PER_STRIP 405

int universeLength[] = {150, 133, 112, 130, 148, 167, 87, 87, 87, 87, 87, 87, 87, 167, 149, 131, 163, 152, 90 };

int ribsInUniverse[] = {7, 3, 2, 2, 2, 2, 1, 1, 1, 1, 1, 1, 1, 2, 2, 2, 3, 4, 6 };

int universeOffsets[] = { 0, 150, 405, 517, 810, 958, 1215, 1302, 1389, 1620, 1707, 1794, 2025, 2112, 2430, 2579, 2835, 2998, 3150 };


byte ip[] = {192, 168, 2, 6  };

int START_SUBNET = 1;
int START_UNIVERSE = 3;
