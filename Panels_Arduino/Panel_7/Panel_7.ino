...
int ledsInRibs[] = {8, 12, 17, 21, 26, 30, 35, 40, 44, 49, 53, 58, 63, 67, 72, 76, 81, 86, 87, 87, 87, 87, 87, 87, 87, 86, 82, 77, 72, 68, 64, 59, 54, 49, 44, 40, 35, 30, 26, 22, 16, 13, 8, 2};

#define NUM_LEDS_PER_STRIP 398

int universeLength[] = {149, 133, 111, 130, 148, 167, 87, 87, 87, 87, 87, 87, 87, 168, 149, 132, 162, 149, 87 };

int ribsInUniverse[] = {7, 3, 2, 2, 2, 2, 1, 1, 1, 1, 1, 1, 1, 2, 2, 2, 3, 4, 6};

int universeOffsets[] = { 0, 149, 398, 509, 796, 944, 1194, 1281, 1368, 1592, 1679, 1766, 1990, 2077, 2388, 2537, 2786, 2948, 3097 };
