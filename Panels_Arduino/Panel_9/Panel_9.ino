...
int ledsInRibs[] = {4, 9, 13, 18, 22, 27, 32, 36, 41, 45, 50, 54, 59, 64, 68, 73, 75, 74, 75, 74, 74, 74, 75, 75, 72, 67, 63, 58, 53, 49, 44, 39, 35, 31, 27, 22, 17, 13, 8, 3 };

#define NUM_LEDS_PER_STRIP 410

int universeLength[] = {161, 136, 113, 132, 148, 149, 148, 149, 147, 130, 160, 83, 156};

int ribsInUniverse[] = {8, 3, 2, 2, 2, 2, 2, 2, 2, 2, 3, 2, 8};

int universeOffsets[] = { 0, 161, 297, 410, 542, 820, 969, 1230, 1379, 1640, 1770, 1930, 2050};
