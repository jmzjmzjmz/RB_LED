...
int ledsInRibs[] = {8, 12, 17, 22, 26, 31, 35, 40, 44, 49, 54, 58, 63, 67, 72, 76, 81, 86, 87, 87, 87, 87, 87, 87, 84, 80, 75, 70, 66, 62, 57, 53, 48, 44, 39, 34, 30, 25, 20, 16, 11, 7 };

#define NUM_LEDS_PER_STRIP 327


int universeLength[] = {151, 133, 112, 130, 148, 167, 87, 87, 87, 87, 87, 87, 164, 75, 136, 119, 145, 164, 18};

int ribsInUniverse[] = {7, 3, 2, 2, 2, 2, 1, 1, 1, 1, 1, 1, 2, 1, 2, 2, 3, 6, 2};

int universeOffsets[] = { 0, 151, 327, 439, 654, 802, 981, 1068, 1155, 1308, 1395, 1482, 1635, 1799, 1962, 2098, 2289, 2434, 2598};
