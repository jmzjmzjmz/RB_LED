...
int universeLength[] = {127, 123, 164, 133, 147, 148, 148, 148, 148, 146, 131, 58, 148, 156, 39 };

int ribsInUniverse[] = {7, 3, 3, 2, 2, 2, 2, 2, 2, 2, 2, 1, 3, 5, 4};

int universeOffsets[] = { 0, 343, 466, 686, 819, 1029, 1177, 1372, 1520, 1715, 1861, 1992, 2058, 2206, 2362 };
