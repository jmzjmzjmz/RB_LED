...
int ledsInRibs[] = {7, 11, 16, 21, 25, 29, 34, 38, 43, 48, 52, 57, 62, 66, 70, 74, 75, 75, 75, 74, 75, 75, 74, 75, 73, 69, 64, 60, 55, 51, 46, 41, 37, 32, 28, 23, 18, 14, 9, 4 };

#define NUM_LEDS_PER_STRIP 317

int universeLength[] = {143, 81, 157, 128, 144, 150, 149, 150, 149, 142, 124, 152, 41, 165 };

int ribsInUniverse[] = {7, 2, 3, 2, 2, 2, 2, 2, 2, 2, 2, 3, 1, 8};

int universeOffsets[] = { 0, 143, 317, 474, 634, 778, 951, 1100, 1268, 1417, 1585, 1709, 1861, 1902};
...
{ 
   universe = universe - UNIVERSE_OFFSET - 65374; 
