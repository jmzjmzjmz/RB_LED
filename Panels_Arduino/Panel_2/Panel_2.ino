...
int ledsInRibs[] = {8, 12, 17, 22, 26, 31, 35, 40, 45, 49, 54, 59, 63, 67, 72, 76, 81, 86, 87, 87, 87, 87, 87, 87, 84, 79, 75, 70, 65, 61, 57, 52, 47, 43, 39, 33, 29, 24, 20, 16, 11, 6};

#define NUM_LEDS_PER_STRIP 320

int universeLength[] = {151, 134, 113, 130, 148, 167, 87, 87, 87, 87, 87, 87, 163, 75, 135, 118, 142, 161, 17};

int ribsInUniverse[] = {7, 3, 2, 2, 2, 2, 1, 1, 1, 1, 1, 1, 2, 1, 2, 2, 3, 6, 2 };

int universeOffsets[] = { 0, 151, 320, 433, 640, 788, 960, 1047, 1134, 1280, 1367, 1454, 1600, 1763, 1920, 2055, 2240, 2382, 2543};
byte ip[] = {192, 168, 2, 2  };
