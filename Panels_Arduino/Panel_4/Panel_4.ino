...
int ledsInRibs[] = {4, 9, 14, 18, 23, 27, 32, 36, 41, 45, 50, 55, 59, 64, 69, 74, 74, 74, 74, 74, 75, 75, 75, 75, 75, 71, 66, 61, 57, 52, 48, 44, 39, 34, 29, 25, 20, 16, 11, 6};

#define NUM_LEDS_PER_STRIP 307

int universeLength[] = {127, 122, 164, 133, 148, 148, 149, 150, 150, 137, 170, 165, 107};

int ribsInUniverse[] = {7, 3, 3, 2, 2, 2, 2, 2, 2, 2, 3, 4, 6};

int universeOffsets[] = { 0, 307, 429, 614, 747, 921, 1069, 1228, 1378, 1535, 1672, 1842, 2007};

byte ip[] = {192, 168, 2, 4  };

int START_SUBNET = 7;
int START_UNIVERSE = 7;
